...
CREATE TABLE `employees`  (
    ...
    INDEX `FK_BID`(`boss_id` ASC) USING BTREE,
    CONSTRAINT `FK_BID` FOREIGN KEY (`boss_id`) REFERENCES `employees` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of employees
-- ----------------------------
INSERT INTO `employees` VALUES (1, 'chan', '12345678', 'Hoàng Thanh Ngoan', '20130335@st.hcmuaf.edu.vn', 'Leader', 8, '2024-05-20 09:00:00', NULL, '2024-07-05 03:09:53', NULL);
INSERT INTO `employees` VALUES (2, 'nghia', '98765412', 'Hồ Thanh Nghĩa', '20130333@st.hcmuaf.edu.vn', 'Dev', 12, '2024-01-25 09:00:00', 1, '2024-07-05 03:13:22', NULL);
INSERT INTO `employees` VALUES (3, 'mai', '12378945', 'Nguyễn Thị Trúc Mai', '20130321@st.hcmuaf.edu.vn', 'Tester', 2, '2023-11-06 09:00:00', 1, '2024-07-05 03:15:14', NULL);
